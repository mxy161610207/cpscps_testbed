...
with open('{}/{}_pos.txt'.format(subfolder, TAG), 'r') as f:
    lines = f.readlines()
# with open('{}/s1.txt'.format(subfolder, TAG), 'r') as f:
#     lines = f.readlines()
...
def all_update():
    ...
    for line_id,line in enumerate(lines):
        ...
        if (count == 0): 
            ...
            if old_scatter :
                old_scatter[0].remove()
                old_scatter[1].remove()

            t1 = canvas_ax.scatter([blue_scatter_x], [blue_scatter_y],
                            s=50,c='blue',marker='o',alpha=0.5)
            t2 = canvas_ax.scatter([red_scatter_x], [red_scatter_y],
            ...
            canvas_sdk.draw()
            input("{} {} {}".format(adjust_cnt,line_id,line))
